...
SPECS: list[AchievementSpec] = [
    ...
    _spec("on_fire", "On Fire", "🔥", "Uncommon", "Win 5 games in a row", _live("best_streak", 5)),
    ...
    _spec("rampage", "Rampage", "😤", "Uncommon", "Destroy 25,000 enemy value in one game", _live("max_kills", 25000)),
    _spec(
        "extinction_event",
        "Extinction Event",
        "🦖",
    ...
    _spec("moral_victory", "Moral Victory", "🥈", "Common", "Be the MVP of a game you lost", _live("losing_mvps", 1)),
    _spec(
        "wasted_brilliance",
        "Wasted Brilliance",
        "🥀",
    ...
    _spec("the_swarm", "The Swarm", "🐜", "Rare", "Build 500 units in one game", _live("max_units_one_game", 500)),
    ...
    _spec("the_closer", "The Closer", "🥊", "Common", "Win a 20+ minute game", _live("max_win_duration", 1200)),
    _spec(
        "special_delivery",
        "Special Delivery",
        "🚁",
    ...
    _spec("night_shift", "Night Shift", "🦉", "Uncommon", "Play 10 late-night games", _live("night_games", 10)),
